...
@Repository
public interface CityAndCountryRepository extends JpaRepository<City, Long> {
    //get all countries
...
//Find all cities in a country
    @Query("SELECT c FROM City c WHERE c.country.iso = :iso")
    List<City> findCitiesByCountry(@Param("iso") String iso);



//add country tio database
//    @Query(value = "INSERT INTO test (id, iso, name, nice_name, iso3, num_code, phone_code) VALUES" +
...
//            "(46, 'CC', 'COCOS (KEELING) ISLANDS', 'Cocos (Keeling) Islands', NULL, 164, 672)," +
...
//            "(164, 'PS', 'PALESTINIAN TERRITORY, OCCUPIED', 'Palestinian Territory, Occupied', NULL, 166, 970)," +
...
//            "(251, 'SS', 'SOUTH SUDAN', 'South Sudan', 'SSD', '728', '211');", nativeQuery = true)
//@Modifying
//@Transactional
